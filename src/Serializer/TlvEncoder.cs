...
internal class TlvEncoder
{
    ...
    public static Func<Address, PropertyIds, byte, ApplicationTags>? CustomTagResolver;

    public static void encode_bacnet_object_id(EncodeBuffer buffer, ObjectTypes objectType, uint instance)
    {
    ...
    public static void encode_bacnet_enumerated(EncodeBuffer buffer, uint value) => encode_bacnet_unsigned(buffer, value);

    public static void encode_application_object_id(EncodeBuffer buffer, ObjectTypes objectType, uint instance)
    {
        using EncodeBuffer encodeBuffer = new();
        encode_bacnet_object_id(encodeBuffer, objectType, instance);
        encode_tag(buffer, (byte)ApplicationTags.BACNET_APPLICATION_TAG_OBJECT_ID, false, (uint)encodeBuffer.Offset);
        buffer.Add(encodeBuffer.Buffer, encodeBuffer.Offset);
    }

    public static void encode_application_unsigned(EncodeBuffer buffer, uint value)
    {
        using EncodeBuffer encodeBuffer = new();
        encode_bacnet_unsigned(encodeBuffer, value);
        encode_tag(buffer, (byte)ApplicationTags.BACNET_APPLICATION_TAG_UNSIGNED_INT, false, (uint)encodeBuffer.Offset);
        buffer.Add(encodeBuffer.Buffer, encodeBuffer.Offset);
    }
    ...
    {
        using EncodeBuffer encodeBuffer = new();
        encode_bacnet_enumerated(encodeBuffer, value);
        encode_tag(buffer, (byte)ApplicationTags.BACNET_APPLICATION_TAG_ENUMERATED, false, (uint)encodeBuffer.Offset);
        buffer.Add(encodeBuffer.Buffer, encodeBuffer.Offset);
    }
    ...
    {
        using EncodeBuffer encodeBuffer = new();
        encode_bacnet_signed(encodeBuffer, value);
        encode_tag(buffer, (byte)ApplicationTags.BACNET_APPLICATION_TAG_SIGNED_INT, false, (uint)encodeBuffer.Offset);
        buffer.Add(encodeBuffer.Buffer, encodeBuffer.Offset);
    }
    ...
    {
        using EncodeBuffer encodeBuffer = new();
        encode_bacnet_character_string(encodeBuffer, value);

        encode_tag(buffer, tagNumber, true, (uint)encodeBuffer.Offset);
        buffer.Add(encodeBuffer.Buffer, encodeBuffer.Offset);
    }
    ...
    {
        encode_tag(buffer, (byte)ApplicationTags.BACNET_APPLICATION_TAG_OCTET_STRING, false, (uint)octetCount);
    ...
    {
        encode_tag(buffer, (byte)ApplicationTags.BACNET_APPLICATION_TAG_BOOLEAN, false,
    ...
    {
        encode_tag(buffer, (byte)ApplicationTags.BACNET_APPLICATION_TAG_REAL, false, 4);
        encode_bacnet_real(buffer, value);
    }

    public static void encode_application_double(EncodeBuffer buffer, double value)
    {
        encode_tag(buffer, (byte)ApplicationTags.BACNET_APPLICATION_TAG_DOUBLE, false, 8);
        encode_bacnet_double(buffer, value);
    }

    private static byte bitstring_bytesUsed(Asn1BitString bitString)
    {
    ...
    private static byte bitstring_octet(Asn1BitString bitString, byte octetIndex)
    {
        byte octet = 0;
    ...
    public static void encode_bitstring(EncodeBuffer buffer, Asn1BitString bitString)
    {
    ...
    public static void encode_application_bitstring(EncodeBuffer buffer, Asn1BitString bitString)
    {
        ...
        encode_tag(buffer, (byte)ApplicationTags.BACNET_APPLICATION_TAG_BIT_STRING, false, bitStringEncodedLength);
        encode_bitstring(buffer, bitString);
    }

    public static void EncodeApplicationDestination(EncodeBuffer buffer, ObjectTypes objectType, uint instance)
    {
    ...
    public static void EncodeApplicationDestination(EncodeBuffer buffer, Address address) => address.Encode(buffer);

    public static void bacapp_encode_application_data(EncodeBuffer buffer, Asn1Value value)
    {
        if (value.Data == null)
        {
            // Modif FC
            buffer.Add((byte)ApplicationTags.BACNET_APPLICATION_TAG_NULL);
            return;
        }

        switch (value.Tag)
        {
            case ApplicationTags.BACNET_APPLICATION_TAG_NULL:
                /* don't encode anything */
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_BOOLEAN:
                encode_application_boolean(buffer, (bool)value.Data);
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_UNSIGNED_INT:
                encode_application_unsigned(buffer, (uint)value.Data);
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_SIGNED_INT:
                encode_application_signed(buffer, (int)value.Data);
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_REAL:
                encode_application_real(buffer, (float)value.Data);
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_DOUBLE:
                encode_application_double(buffer, (double)value.Data);
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_OCTET_STRING:
                encode_application_octet_string(buffer, (byte[])value.Data, 0, ((byte[])value.Data).Length);
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_CHARACTER_STRING:
                encode_application_character_string(buffer, (string)value.Data);
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_BIT_STRING:
                encode_application_bitstring(buffer, (Asn1BitString)value.Data);
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_ENUMERATED:
                encode_application_enumerated(buffer, (uint)(dynamic)value.Data);
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_DATE:
                encode_application_date(buffer, (DateTime)value.Data);
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_TIME:
                encode_application_time(buffer, (DateTime)value.Data);
                break;
            // Added for EventTimeStamp
            case ApplicationTags.BACNET_APPLICATION_TAG_TIMESTAMP:
                bacapp_encode_timestamp(buffer, (Asn1GenericTime)value.Data);
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_DATETIME:
                bacapp_encode_datetime(buffer, (DateTime)value.Data);
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_OBJECT_ID:
                encode_application_object_id(buffer, ((ObjectId)value.Data).type,
                    ((ObjectId)value.Data).instance);
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_COV_SUBSCRIPTION:
                encode_cov_subscription(buffer, (Asn1COVSubscription)value.Data);
                //is this the right way to do it, I wonder?
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_READ_ACCESS_RESULT:
                encode_read_access_result(buffer, (Asn1ReadAccessResult)value.Data);
                //is this the right way to do it, I wonder?
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_READ_ACCESS_SPECIFICATION:
                encode_read_access_specification(buffer, (Asn1ReadAccessSpecification)value.Data);
                //is this the right way to do it, I wonder?
                break;

            case ApplicationTags.BACNET_APPLICATION_TAG_DESTINATION:
                switch (value.Data)
                {
                    case ObjectId oid:
                    ...
                    default:
                        throw new ArgumentException($"Unsupported destination value '{value.Data}' (type {value.GetType()})");
                }
                break;

            default:
                //context specific
                if (value.Data is byte[] arr)
                {
                ...
                else
                {
                    try
                    {
                        ...
                        else
                        {
                            ...
                            ((IEncode)value.Data).Encode(buffer);
                        }
                    }
                    catch
                    {
    ...
    public static void bacapp_encode_device_obj_property_ref(EncodeBuffer buffer, Asn1DeviceObjectPropertyReference value)
    {
        ...
        if (value.deviceIndentifier.type == ObjectTypes.OBJECT_DEVICE)
            encode_context_object_id(buffer, 3, value.deviceIndentifier.type, value.deviceIndentifier.instance);
    }

    public static void bacapp_encode_context_device_obj_property_ref(EncodeBuffer buffer, byte tagNumber, Asn1DeviceObjectPropertyReference value)
    {
    ...
    public static void encode_context_bitstring(EncodeBuffer buffer, byte tagNumber, Asn1BitString bitString)
    {
        uint bitStringEncodedLength = 1; /* 1 for the bits remaining octet */
    ...
    public static void encode_context_object_id(EncodeBuffer buffer, byte tagNumber, ObjectTypes objectType, uint instance)
    {
        encode_tag(buffer, tagNumber, true, 4);
    ...
    {
        encode_tag(buffer, (byte)ApplicationTags.BACNET_APPLICATION_TAG_DATE, false, 4);
        encode_bacnet_date(buffer, value);
    }

    public static void encode_application_time(EncodeBuffer buffer, DateTime value)
    {
        encode_tag(buffer, (byte)ApplicationTags.BACNET_APPLICATION_TAG_TIME, false, 4);
        encode_bacnet_time(buffer, value);
    }
    ...
    public static void bacapp_encode_timestamp(EncodeBuffer buffer, Asn1GenericTime value)
    {
        switch (value.Tag)
        {
            case Asn1TimestampTags.TIME_STAMP_TIME:
                encode_context_time(buffer, 0, value.Time);
                break;

            case Asn1TimestampTags.TIME_STAMP_SEQUENCE:
                encode_context_unsigned(buffer, 1, value.Sequence);
                break;

            case Asn1TimestampTags.TIME_STAMP_DATETIME:
                bacapp_encode_context_datetime(buffer, 2, value.Time);
                break;

            case Asn1TimestampTags.TIME_STAMP_NONE:
                break;
    ...
    public static void bacapp_encode_context_timestamp(EncodeBuffer buffer, byte tagNumber, Asn1GenericTime value)
    {
        if (value.Tag != Asn1TimestampTags.TIME_STAMP_NONE)
        {
            encode_opening_tag(buffer, tagNumber);
    ...
    public static void encode_application_character_string(EncodeBuffer buffer, string value)
    {
        ...
        encode_tag(buffer, (byte)ApplicationTags.BACNET_APPLICATION_TAG_CHARACTER_STRING, false,
            (uint)encodeBuffer.Offset);
        buffer.Add(encodeBuffer.Buffer, encodeBuffer.Offset);
    }

    public static void encode_bacnet_character_string(EncodeBuffer buffer, string value)
    {
        buffer.Add((byte)Asn1CharacterStringEncodings.CHARACTER_UTF8);
    ...
    public static void encode_read_access_specification(EncodeBuffer buffer, Asn1ReadAccessSpecification value)
    {
    ...
    public static void encode_read_access_result(EncodeBuffer buffer, Asn1ReadAccessResult value)
    {
        /* Tag 0: BACnetObjectIdentifier */
        encode_context_object_id(buffer, 0, value.objectIdentifier.type, value.objectIdentifier.instance);
        ...
        foreach (var pValue in value.values)
        {
            ...
            if (pValue.value != null && pValue.value[0].Data is Error)
            {
                /* Tag 5: Error */
                encode_opening_tag(buffer, 5);
                encode_application_enumerated(buffer, (uint)((Error)pValue.value[0].Data).ErrorClass);
                encode_application_enumerated(buffer, (uint)((Error)pValue.value[0].Data).ErrorCode);
    ...
    public static int decode_read_access_result(Address address, byte[] buffer, int offset, int apduLen, out Asn1ReadAccessResult value)
    {
        var len = 0;

        value = new Asn1ReadAccessResult();
        ...
        var valueList = new List<PropertyValue>();
        while (apduLen - len > 0)
        {
            var new_entry = new PropertyValue();
            ...
            if (tagNumber == 4)
            {
                var localValueList = new List<Asn1Value>();
                while (!decode_is_closing_tag_number(buffer, offset + len, 4))
                {
                    tagLen = bacapp_decode_application_data(address, buffer, offset + len, apduLen + offset - 1,
                        value.objectIdentifier.type, (PropertyIds)new_entry.property.propertyIdentifier, out var v);
                    if (tagLen < 0) return -1;
                    len += tagLen;
                    localValueList.Add(v);
                }
                // FC : two values one Date & one Time => change to one datetime
                if (localValueList.Count == 2 && localValueList[0].Tag == ApplicationTags.BACNET_APPLICATION_TAG_DATE && localValueList[1].Tag == ApplicationTags.BACNET_APPLICATION_TAG_TIME)
                {
                    var date = (DateTime)localValueList[0].Data;
                    var time = (DateTime)localValueList[1].Data;
                    ...
                    localValueList.Add(new Asn1Value(ApplicationTags.BACNET_APPLICATION_TAG_DATETIME, bdatetime));
            ...
            else if (tagNumber == 5)
            {
                ...
                len += decode_enumerated(buffer, offset + len, lenValueType, out err._errorClass);
                len += decode_tag_number_and_value(buffer, offset + len, out tagNumber, out lenValueType);
                len += decode_enumerated(buffer, offset + len, lenValueType, out err._errorCode);
                if (!decode_is_closing_tag_number(buffer, offset + len, 5))
                    return -1;
                len++;

                new_entry.value = new[] { new Asn1Value(ApplicationTags.BACNET_APPLICATION_TAG_ERROR, err) };
            }
    ...
    public static int decode_read_access_specification(byte[] buffer, int offset, int apdu_len, out Asn1ReadAccessSpecification value)
    {
        var len = 0;

        value = new Asn1ReadAccessSpecification();
        ...
        /* properties */
        var propertyIdAndArrayIndex = new List<PropertyReference>();
        while (apdu_len - len > 1 && !decode_is_closing_tag_number(buffer, offset + len, 1))
        {
            var p_ref = new PropertyReference();
    ...
    public static int decode_device_obj_property_ref(byte[] buffer, int offset, int apduLen, out Asn1DeviceObjectPropertyReference value)
    {
        var len = 0;

        value = new Asn1DeviceObjectPropertyReference { arrayIndex = BACNET_ARRAY_ALL };
    ...
    public static bool IS_EXTENDED_TAG_NUMBER(byte x) => (x & 0xF0) == 0xF0;

    public static bool IS_EXTENDED_VALUE(byte x) => (x & 0x07) == 5;

    public static bool IS_CONTEXT_SPECIFIC(byte x) => (x & 0x8) == 0x8;

    public static bool IS_APPLICATION_TAG(byte x) => !IS_CONTEXT_SPECIFIC(x);

    public static bool IS_OPENING_TAG(byte x) => (x & 0x07) == 6;

    public static bool IS_CLOSING_TAG(byte x) => (x & 0x07) == 7;
    ...
    private static bool multi_charset_characterstring_decode(byte[] buffer, int offset, byte encoding, uint length, out string charString)
    {
        try
        {
            ...
            switch ((Asn1CharacterStringEncodings)encoding)
            {
                // 'normal' encoding, backward compatible ANSI_X34 (for decoding only)
                case Asn1CharacterStringEncodings.CHARACTER_UTF8:
                    e = Encoding.UTF8;
                    break;
                ...
                case Asn1CharacterStringEncodings.CHARACTER_UCS2:
                ...
                case Asn1CharacterStringEncodings.CHARACTER_UCS4:
                ...
                case Asn1CharacterStringEncodings.CHARACTER_ISO8859:
                ...
                case Asn1CharacterStringEncodings.CHARACTER_MS_DBCS:
                    e = Encoding.GetEncoding("shift_jis");
                    break;

                // FIXME: somebody in Japan (or elsewhere) could help,test&validate if such devices exist ?
                // http://www.sljfaq.org/afaq/encodings.html
                case Asn1CharacterStringEncodings.CHARACTER_JISX_0208:
    ...
    private static void bitstring_set_octet(ref Asn1BitString bitString, byte index, byte octet)
    {
        if (index < MAX_BITSTRING_BYTES)
            bitString.value[index] = octet;
    }

    private static void bitstring_set_bits_used(ref Asn1BitString bitString, byte bytesUsed, byte unusedBits)
    {
    ...
    public static int decode_bitstring(byte[] buffer, int offset, uint lenValue, out Asn1BitString bitString)
    {
        var len = 0;

        bitString = new Asn1BitString { value = new byte[MAX_BITSTRING_BYTES] };
        if (lenValue > 0)
        {
    ...
    public static int decode_application_time(byte[] buffer, int offset, out DateTime btime)
    {
        ...
        if (tagNumber == (byte)ApplicationTags.BACNET_APPLICATION_TAG_TIME)
        {
            len++;
    ...
    public static int decode_application_date(byte[] buffer, int offset, out DateTime bdate)
    {
        ...
        if (tagNumber == (byte)ApplicationTags.BACNET_APPLICATION_TAG_DATE)
        {
            len++;
    ...
    public static int bacapp_decode_data(byte[] buffer, int offset, int maxLength, ApplicationTags tagDataType, uint lenValueType, out Asn1Value value)
    {
        var len = 0;
        uint uintValue;

        value = new Asn1Value { Tag = tagDataType };
        ...
        switch (tagDataType)
        {
            ...
            case ApplicationTags.BACNET_APPLICATION_TAG_ENUMERATED:
                len = decode_enumerated(buffer, offset, lenValueType, out value.Data);
                break;
            ...
            case ApplicationTags.BACNET_APPLICATION_TAG_OBJECT_ID:
                ...
                value.Data = new ObjectId((ObjectTypes)objectType, instance);
                break;
        }
    ...
    private static ApplicationTags bacapp_context_tag_type(Address address, PropertyIds property, byte tagNumber)
    {
        var tag = ApplicationTags.MAX_BACNET_APPLICATION_TAG;

        switch (property)
        {
            case PropertyIds.PROP_ACTUAL_SHED_LEVEL:
            case PropertyIds.PROP_REQUESTED_SHED_LEVEL:
            case PropertyIds.PROP_EXPECTED_SHED_LEVEL:
                switch (tagNumber)
                {
                    case 0:
                    case 1:
                        tag = ApplicationTags.BACNET_APPLICATION_TAG_UNSIGNED_INT;
                        break;

                    case 2:
                        tag = ApplicationTags.BACNET_APPLICATION_TAG_REAL;
                        break;
                }
                break;

            case PropertyIds.PROP_ACTION:
                switch (tagNumber)
                {
                    case 0:
                    case 1:
                        tag = ApplicationTags.BACNET_APPLICATION_TAG_OBJECT_ID;
                        break;

                    case 2:
                        tag = ApplicationTags.BACNET_APPLICATION_TAG_ENUMERATED;
                        break;
                    ...
                    case 7:
                    case 8:
                        tag = ApplicationTags.BACNET_APPLICATION_TAG_BOOLEAN;
                        break;
            ...
            case PropertyIds.PROP_LIST_OF_GROUP_MEMBERS:
            ...
            case PropertyIds.PROP_EXCEPTION_SCHEDULE:
                switch (tagNumber)
                {
                    case 1:
                        tag = ApplicationTags.BACNET_APPLICATION_TAG_OBJECT_ID;
            ...
            case PropertyIds.PROP_LOG_DEVICE_OBJECT_PROPERTY:
                switch (tagNumber)
                {
                    case 0: /* Object ID */
                    case 3: /* Device ID */
            ...
            case PropertyIds.PROP_SUBORDINATE_LIST:
            case PropertyIds.PROP_ZONE_MEMBERS:
            ...
            case PropertyIds.PROP_RECIPIENT_LIST:
            ...
            case PropertyIds.PROP_ACTIVE_COV_SUBSCRIPTIONS:
    ...
    public static int bacapp_decode_context_data(byte[] buffer, int offset, uint maxAPDULen, ApplicationTags propertyTag, out Asn1Value value)
    {
        int apduLen = 0, len = 0;
        ...
        if (IS_CONTEXT_SPECIFIC(buffer[offset]))
        {
                ...
                !decode_is_closing_tag_number(buffer, offset + len, tagNumber))
            {
                ...
                if (propertyTag < ApplicationTags.MAX_BACNET_APPLICATION_TAG)
                {
    ...
    public static int bacapp_decode_application_data(Address address, byte[] buffer, int offset, int maxOffset, ObjectTypes objectType, PropertyIds propertyId, out Asn1Value value)
    {
        var len = 0;
        ...
        if (!IS_CONTEXT_SPECIFIC(buffer[offset]))
        {
            var tagLen = decode_tag_number_and_value(buffer, offset, out ApplicationTags tagNumber, out uint lenValueType);
            if (tagLen > 0)
            {
                len += tagLen;
    ...
    public static int bacapp_decode_context_application_data(Address address, byte[] buffer, int offset, int maxOffset, ObjectTypes objectType, PropertyIds propertyId, out Asn1Value value)
    {
        var len = 0;
        ...
        if (IS_CONTEXT_SPECIFIC(buffer[offset]))
        {
            ...
            if (propertyId == PropertyIds.PROP_LIST_OF_GROUP_MEMBERS)
            {
                tagLen = decode_read_access_specification(buffer, offset, maxOffset, out var v);
                if (tagLen < 0) return -1;
                value.Tag = ApplicationTags.BACNET_APPLICATION_TAG_READ_ACCESS_SPECIFICATION;
                value.Data = v;
                return tagLen;
            }
            if (propertyId == PropertyIds.PROP_ACTIVE_COV_SUBSCRIPTIONS)
            {
                tagLen = decode_cov_subscription(buffer, offset, maxOffset, out var v);
                if (tagLen < 0) return -1;
                value.Tag = ApplicationTags.BACNET_APPLICATION_TAG_COV_SUBSCRIPTION;
                value.Data = v;
                return tagLen;
            }
            if (objectType == ObjectTypes.OBJECT_GROUP && propertyId == PropertyIds.PROP_PRESENT_VALUE)
            {
                tagLen = decode_read_access_result(address, buffer, offset, maxOffset, out Asn1ReadAccessResult v);
                if (tagLen < 0) return -1;
                value.Tag = ApplicationTags.BACNET_APPLICATION_TAG_READ_ACCESS_RESULT;
                value.Data = v;
                return tagLen;
            }
            if (propertyId == PropertyIds.PROP_LIST_OF_OBJECT_PROPERTY_REFERENCES ||
                propertyId == PropertyIds.PROP_LOG_DEVICE_OBJECT_PROPERTY ||
                propertyId == PropertyIds.PROP_OBJECT_PROPERTY_REFERENCE)
            {
                tagLen = decode_device_obj_property_ref(buffer, offset, maxOffset, out var v);
                if (tagLen < 0) return -1;
                value.Tag = ApplicationTags.BACNET_APPLICATION_TAG_OBJECT_PROPERTY_REFERENCE;
                value.Data = v;
                return tagLen;
            }
            if (propertyId == PropertyIds.PROP_DATE_LIST)
            {
                var v = new Asn1CalendarEntry();
                tagLen = v.Decode(buffer, offset, (uint)maxOffset);
                if (tagLen < 0) return -1;
                value.Tag = ApplicationTags.BACNET_APPLICATION_TAG_CONTEXT_SPECIFIC_DECODED;
                value.Data = v;
                return tagLen;
            }
            if (propertyId == PropertyIds.PROP_EVENT_TIME_STAMPS)
            {
                ...
                if (tagNumber == 0) // Time without date
                {
                    ...
                    value.Tag = ApplicationTags.BACNET_APPLICATION_TAG_TIMESTAMP;
                    value.Data = dt;
                }
                else if (tagNumber == 1) // sequence number
                {
                    len += decode_unsigned(buffer, offset + len, lenValueType, out var val);
                    value.Tag = ApplicationTags.BACNET_APPLICATION_TAG_UNSIGNED_INT;
                    value.Data = val;
                }
            ...
            while (len + offset <= maxOffset && !IS_CLOSING_TAG(buffer[offset + len]))
            {
                ...
                // The former happens when parsing the Address within a RecipientList
                // if the Address has a broadcast MAC address
                if (IS_OPENING_TAG(buffer[offset + len]))
                {
                    len += tagLen;
                    tagLen = bacapp_decode_application_data(address, buffer, offset + len, maxOffset,
                        ObjectTypes.MAX_BACNET_OBJECT_TYPE, PropertyIds.MAX_BACNET_PROPERTY_ID,
                        out var subValue);
                    if (tagLen < 0) return -1;
                    list.Add(subValue);
                    len += tagLen;
                ...
                else
                {
                    ...
                    if (overrideTagNumber != ApplicationTags.MAX_BACNET_APPLICATION_TAG)
                        subTagNumber = (byte)overrideTagNumber;

                    //try app decode
                    var subTagLen = bacapp_decode_data(buffer, offset + len + tagLen, maxOffset,
                        (ApplicationTags)subTagNumber, lenValueType, out var subValue);
                    ...
                    else
                    {
                        ...
                        subValue =
                            new Asn1Value(ApplicationTags.BACNET_APPLICATION_TAG_CONTEXT_SPECIFIC_ENCODED,
                                contextSpecific);
    ...
    public static int decode_object_id(byte[] buffer, int offset, out ObjectTypes objectType, out uint instance)
    {
        var len = decode_unsigned32(buffer, offset, out var value);
        objectType = (ObjectTypes)(value >> BACNET_INSTANCE_BITS & BACNET_MAX_OBJECT);
        instance = value & BACNET_MAX_INSTANCE;
    ...
    public static bool decode_is_application_tag(byte[] buffer, int offset, ApplicationTags tagNumber)
    {
        decode_tag_number(buffer, offset, out var myTagNumber);
    ...
    public static bool decode_is_closing_tag(byte[] buffer, int offset) => (buffer[offset] & 0x07) == 7;

    public static bool decode_is_opening_tag(byte[] buffer, int offset) => (buffer[offset] & 0x07) == 6;
    ...
    public static void encode_cov_subscription(EncodeBuffer buffer, Asn1COVSubscription value)
    {
        ...
        /* CHOICE - address [1] Address - opening */
        encode_opening_tag(buffer, 1);
    ...
    public static int decode_cov_subscription(byte[] buffer, int offset, int apduLen, out Asn1COVSubscription value)
    {
        var len = 0;

        value = new Asn1COVSubscription { Recipient = new Address(AddressTypes.None, 0, null) };
    ...
    public static int decode_context_property_state(byte[] buffer, int offset, byte tagNumber, out PropertyState value)
    {
    ...
    public static int decode_property_state(byte[] buffer, int offset, out PropertyState value)
    {
        value = default;
    ...
    public static int decode_context_bitstring(byte[] buffer, int offset, byte tagNumber, out Asn1BitString value)
    {
